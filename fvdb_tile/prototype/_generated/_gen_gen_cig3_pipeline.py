...
@ct.kernel
def gen_cig3_pipeline(query_arr, upper_idx_arr, upper_masks_arr, upper_prefix_arr, upper_offsets_arr, lower_masks_arr, lower_prefix_arr, lower_offsets_arr, leaf_masks_arr, leaf_prefix_arr, leaf_offsets_arr, result_arr, TILE: ct.Constant[int]):
    bid = ct.bid(0)
