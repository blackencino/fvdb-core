...
@ct.kernel
def bench_cig3_R1(query_arr, root_coords_arr, upper_masks_arr, upper_abs_prefix_arr, lower_masks_arr, lower_abs_prefix_arr, leaf_masks_arr, leaf_abs_prefix_arr, result_arr, TILE: ct.Constant[int]):
    bid = ct.bid(0)
