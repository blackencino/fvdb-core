...
//
#ifndef FVDB_DETAIL_AUTOGRAD_CONVOLUTION_GATHERSCATTER_H
#define FVDB_DETAIL_AUTOGRAD_CONVOLUTION_GATHERSCATTER_H
...
#endif // FVDB_DETAIL_AUTOGRAD_CONVOLUTION_GATHERSCATTER_H
