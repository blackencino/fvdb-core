...
class ConvBackendConfig:
    ...
    def to(self, device: torch.device) -> ConvBackendConfig: ...

class GatherScatterAutogradTopology:
    @property
    def neighbor_map(self) -> torch.Tensor: ...
    @property
    def neighbor_sizes(self) -> torch.Tensor: ...
    @property
    def source_total_voxel_count(self) -> int: ...
    @property
    def target_total_voxel_count(self) -> int: ...
    @property
    def kernel_size(self) -> tuple[int, int, int]: ...
    @property
    def stride(self) -> tuple[int, int, int]: ...
    def to(self, device: torch.device) -> GatherScatterAutogradTopology: ...

class ConvBackendGatherScatter:
    @property
    def config(self) -> ConvBackendConfig: ...
    @property
    def topology(self) -> GatherScatterAutogradTopology: ...
    @staticmethod
    def create(
    ...
    def to(self, device: torch.device) -> ConvBackendGatherScatter: ...
    def execute(self, input: JaggedTensor, weights: torch.Tensor) -> JaggedTensor: ...
    def execute_flat(self, input: torch.Tensor, weights: torch.Tensor) -> torch.Tensor: ...
